    ...
    <nav class="relative bg-black flex w-full items-center justify-between transition-all shadow-none duration-250 ease-soft-in "
        ...
        <div class="flex items-center p-4 gap-4">
            <div class="flex grow sm:mt-0 sm:mr-6 md:mr-0 lg:flex lg:basis-auto justify-end">
                ...
                <div class="hidden ease-in-out relative z-10" id="profileDropdown">
                    <div class=" bg-slate-200 flex flex-col rounded-xl absolute right-1 top-12 w-40 p-5 gap-1">

                        <p class="bg-white px-2 shadow-none rounded">{{ $user_nama }}</p>
                        <button class="border"><a href="{{ route('ShowChangePasswordForm') }}">Ubah Password</a></button>
                        <button class="border"><a href="{{ route('logout') }}">Logout</a></button>
                    </div>
                </div>
            </div>
            <div class="lg:hidden">
