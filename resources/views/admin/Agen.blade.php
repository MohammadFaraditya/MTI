        ...
        <div class="flex-none w-full max-w-full px-3">
            <div
                ...
                <div
                    ...
                    <h6>Tabel Agen</h6>
                    <a href="" class="bg-slate-500 text-white p-3 rounded-lg text-xs">+ Tambah Agen</a>
                </div>
                        ...
                        <table class="items-center w-full mb-0 align-top border-gray-200 text-slate-500">
                            ...
                            <tbody>
                                <td
                                    ...
                                    <p class="mb-0 text-xs font-semibold leading-tight ">AG01</p>
                                </td>
                                <td
                                    class="p-2 align-middle bg-transparent border-b whitespace-nowrap shadow-transparent">
                                    <p class="mb-0 text-xs font-semibold leading-tight">Agen Poris
                                    </p>
                                </td>
                                <td
                                ...
                                <td class="p-2   align-middle bg-transparent border-b shadow-transparent ">
                                    <a class="mb-0 text-xs font-semibold leading-tight ">Teminal Poris Blok A No
                                        14</a>
                                </td>
                                <td class="p-2  align-middle bg-transparent border-b shadow-transparent ">
                                    <a class="mb-0 text-xs font-semibold leading-tight ">AgenPoris</a>
                                </td>
                                <td class="p-2 align-middle bg-transparent border-b shadow-transparent ">
                                    <a class="mb-0 text-xs font-semibold leading-tight ">12345</a>
                                </td>
                                <td class="p-2 align-middle bg-transparent border-b shadow-transparent ">
                                    <a class="mb-0 text-xs font-semibold leading-tight ">KOAG01</a>
                                </td>
                                <td class="p-2 align-middle bg-transparent border-b shadow-transparent ">
                                    <a class="mb-0 text-xs font-semibold leading-tight ">Yayan</a>
                                </td>
                                <td
                                    class="p-2 pl-6 align-middle bg-transparent border-b whitespace-nowrap shadow-transparent">
