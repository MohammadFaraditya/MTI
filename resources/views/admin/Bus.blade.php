        ...
        <div class="flex-none w-full max-w-full px-3">
            <div
                ...
                <div
                    ...
                    <h6>Tabel Bus</h6>
                    <a href="" class="bg-slate-500 text-white p-3 rounded-lg text-xs">+ Tambah Bus</a>
                </div>
                        ...
                        <table class="items-center w-full mb-0 align-top border-gray-200 text-slate-500">
                            ...
                            <tbody>
                                <td
                                    ...
                                    <p class="mb-0 text-xs font-semibold leading-tight ">RMH-01</p>
                                </td>
                                <td
                                    class="p-2 align-middle bg-transparent border-b whitespace-nowrap shadow-transparent">
                                    <p class="mb-0 text-xs font-semibold leading-tight">Jetbus 2 HDD
                                    </p>
                                </td>
                                <td
                                    class="p-2 pl-3 align-middle bg-transparent border-b whitespace-nowrap shadow-transparent">
                                    <p class="mb-0 text-xs font-semibold leading-tight">Mercy 1626</p>
                                </td>
                                <td class="p-2 pl-6  align-middle bg-transparent border-b shadow-transparent ">
                                    <a class="mb-0 text-xs font-semibold leading-tight ">2013</a>
                                </td>
                                <td class="p-2 pl-6  align-middle bg-transparent border-b shadow-transparent ">
                                    <a class="mb-0 text-xs font-semibold leading-tight ">22/11/2023</a>
                                </td>
                                <td class="p-2 pl-6  align-middle bg-transparent border-b shadow-transparent ">
                                    <a class="mb-0 text-xs font-semibold leading-tight ">Aktif</a>
                                </td>
                                <td class="p-2 pl-6  align-middle bg-transparent border-b shadow-transparent ">
                                    <a class="mb-0 text-xs font-semibold leading-tight ">Executive</a>
                                </td>
                                <td class="p-2 pl-6  align-middle bg-transparent border-b shadow-transparent ">
                                    <a class="mb-0 text-xs font-semibold leading-tight ">40</a>
                                </td>
                                <td class="p-2 pl-6  align-middle bg-transparent border-b shadow-transparent ">
                                    <a class="mb-0 text-xs font-semibold leading-tight ">S01</a>
                                </td>
                                <td class="p-2 pl-6  align-middle bg-transparent border-b shadow-transparent ">
