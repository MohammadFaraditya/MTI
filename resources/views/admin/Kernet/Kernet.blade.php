                ...
                <div
                    ...
                    <div
                        ...
                        <div class="flex gap-6">
                            <a href="{{ route('index.adminKernet') }}">
                                <h6 class="text-xl">Tabel Kernet</h6>
                            </a>
                            <form action="{{ route('search.kernet') }}" method="GET">
                                <div
                                    ...
                                    <input type="search"
                                        ...
                                        placeholder="Cari Kernet" name="search" />
                                    <button class="pl-3">
                        ...
                        <a href="/admin/kernet/add-kernet" class="bg-slate-500 text-white p-3 rounded-lg text-xs">+ Tambah
                            Kernet</a>
                    </div>
                    <div class="flex-auto px-0 pt-0 pb-2">
                        <div class="flex p-0">
                            <table class="items-center w-full mb-0 align-top border-gray-200 text-slate-500">
                                ...
                                <tbody>
                                    @foreach ($kernet as $kernet)
                                        <tr>
                                            <td
                                                class="p-2 pl-6 align-middle bg-transparent border-b whitespace-nowrap shadow-transparent">
                                                <p class="mb-0 text-xs font-semibold leading-tight ">{{ $kernet->ID_Akun }}
                                                </p>
                                            </td>
                                            <td
                                                class="p-2 align-middle bg-transparent border-b whitespace-nowrap shadow-transparent">
                                                <p class="mb-0 text-xs font-semibold leading-tight">{{ $kernet->Nama }}
                                                </p>
                                            </td>
                                            <td
                                            ...
                                            <td class="p-2   align-middle bg-transparent border-b shadow-transparent ">
                                                <a
                                                    class="mb-0 text-xs font-semibold leading-tight ">{{ $kernet->Alamat }}</a>
                                            </td>
                                            <td class="p-2  align-middle bg-transparent border-b shadow-transparent ">
                                                <a class="mb-0 text-xs font-semibold leading-tight ">{{ $kernet->Kota_Kelahiran }}
                                            </td>
                                            <td class="p-2 align-middle bg-transparent border-b shadow-transparent ">
                                                <a
                                                    class="mb-0 text-xs font-semibold leading-tight ">{{ $kernet->Tanggal_Lahir }}</a>
                                            </td>
                                            <td class="p-2 align-middle bg-transparent border-b shadow-transparent ">
                                                <a
                                                    class="mb-0 text-xs font-semibold leading-tight ">{{ $kernet->Username }}</a>
                                            </td>
                                            <td class="p-2 align-middle bg-transparent border-b shadow-transparent ">
                                                <a
                                                    class="mb-0 text-xs font-semibold leading-tight ">{{ substr($kernet->Password, 0, 7) }}...</a>
                                            </td>
                                            <td class="p-2 align-middle bg-transparent border-b shadow-transparent ">
                                                <a
                                                    class="mb-0 text-xs font-semibold leading-tight ">{{ $kernet->ID_Bus }}</a>
                                            </td>
                                            <td class="p-2 align-middle bg-transparent border-b shadow-transparent ">
                                                <a
                                                    class="mb-0 text-xs font-semibold leading-tight ">{{ $kernet->Status }}</a>
                                            </td>
                                            <td
                                                class="p-2 pl-6 align-middle bg-transparent border-b whitespace-nowrap shadow-transparent">
                                                <a href="/admin/kernet/edit-kernet/{{ $kernet->ID_Akun }}"><svg
                                            ...
                                            <td
                                                class="p-2 pl-6 align-middle bg-transparent border-b whitespace-nowrap shadow-transparent">
                                                <form action="kernet/delete-kernet/{{ $kernet->ID_Akun }}" method="POST">
                                                    @csrf
                                                    @method('delete')
                                                    <button type="submit">
