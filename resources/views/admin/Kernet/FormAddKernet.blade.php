...
@section('card')
    <div class="p-8 pl-6 ">
        <h1 class="font-medium text-2xl">Tambah Kernet</h1>
        <form action="/admin/kernet/store-kernet" method="POST">
            @csrf
            <div>
                <label for="ID_Kernet" class="text-sm text-gray-700 block mb-1 font-medium">ID_Kernet</label>
                <input type="text" name="ID_Kernet"
                    class="bg-gray-100 border border-gray-200 rounded py-1 px-3 block focus:ring-blue-500 focus:border-blue-500 text-gray-700 w-full" />
            </div>

            <div>
                <label for="Nama_Kernet" class="text-sm text-gray-700 block mb-1 font-medium">Nama Kernet</label>
                <input type="text" name="Nama_Kernet"
                    class="bg-gray-100 border border-gray-200 rounded py-1 px-3 block focus:ring-blue-500 focus:border-blue-500 text-gray-700 w-full" />
            </div>
