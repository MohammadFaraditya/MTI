...
@section('card')
    <div class="p-8 pl-6 ">
        <h1 class="font-medium text-2xl">Edit Data Kernet {{ $kernet->Nama }} ID {{ $kernet->ID_Akun }}</h1>
        <form action="/admin/kernet/update-kernet/{{ $kernet->ID_Akun }}" method="POST">
            @method('PUT')
            @csrf
            <div>
                <label for="Nama_Kernet" class="text-sm text-gray-700 block mb-1 font-medium">Nama kernet</label>
                <input type="text" name="Nama_Kernet" value="{{ $kernet->Nama }}"
                    class="bg-gray-100 border border-gray-200 rounded py-1 px-3 block focus:ring-blue-500 focus:border-blue-500 text-gray-700 w-full" />
            </div>

            <div>
                <label for="No_Telepon" class="text-sm text-gray-700 block mb-1 font-medium">No Telepon</label>
                <input type="text" name="No_Telepon" value="{{ $kernet->No_Telepon }}"
                    class="bg-gray-100 border border-gray-200 rounded py-1 px-3 block focus:ring-blue-500 focus:border-blue-500 text-gray-700 w-full" />
            </div>

            <div>
                <label for="Alamat" class="text-sm text-gray-700 block mb-1 font-medium">Alamat</label>
                <input type="text" name="Alamat" value="{{ $kernet->Alamat }}"
                    class="bg-gray-100 border border-gray-200 rounded py-1 px-3 block focus:ring-blue-500 focus:border-blue-500 text-gray-700 w-full" />
            </div>

            <div>
                <label for="Kota_Kelahiran" class="text-sm text-gray-700 block mb-1 font-medium">Kota Kelahiran</label>
                <input type="text" name="Kota_Kelahiran" value="{{ $kernet->Kota_Kelahiran }}"
                    class="bg-gray-100 border border-gray-200 rounded py-1 px-3 block focus:ring-blue-500 focus:border-blue-500 text-gray-700 w-full" />
            </div>

            <div>
                <label for="Tanggal_Lahir" class="text-sm text-gray-700 block mb-1 font-medium">Tanggal Lahir</label>
                <input type="date" name="Tanggal_Lahir" value="{{ $kernet->Tanggal_Lahir }}"
                    class="bg-gray-100 border border-gray-200 rounded py-1 px-3 block focus:ring-blue-500 focus:border-blue-500 text-gray-700 w-full" />
            </div>

            <div>
                <label for="Username" class="text-sm text-gray-700 block mb-1 font-medium">Username</label>
                <input type="text" name="Username" value="{{ $kernet->Username }}"
                    class="bg-gray-100 border border-gray-200 rounded py-1 px-3 block focus:ring-blue-500 focus:border-blue-500 text-gray-700 w-full" />
            </div>
            ...
            <div>
                ...
                <select name="ID_Bus"
                    class="bg-gray-100 border border-gray-200 rounded py-1 px-3 block focus:ring-blue-500 focus:border-blue-500 text-gray-700 w-full">
                    <option selected>{{ $kernet->ID_Bus }}</option>
            ...
            <div>
                ...
                <input type="text" name="Status" value="{{ $kernet->Status }}"
                    class="bg-gray-100 border border-gray-200 rounded py-1 px-3 block focus:ring-blue-500 focus:border-blue-500 text-gray-700 w-full" />
            </div>
    </div>
