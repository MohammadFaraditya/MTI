                    ...
                    <div class="flex justify-between">
                        <div class="p-6 pb-0 mb-0 bg-white border-b-0 border-b-solid rounded-t-2xl border-b-transparent">
                            ...
                            @foreach ($komisi as $komisi)
                                <h6>Komisi Agen = {{ $komisi->Komisi_Agen }}% <button class="ml-4 mt-[-10px]"
                                        id="ButtonKomisi"><svg xmlns="http://www.w3.org/2000/svg" fill="none"
                        ...
                        <div class="p-4">
                            <h6 class="">Cari Komisi Per Tanggal</h6>
                            <form action="{{ route('SearchKomisi') }}">
