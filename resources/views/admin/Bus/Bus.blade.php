                ...
                <div
                    ...
                    <div
                        ...
                        <div class="flex gap-6">
                            <a href="{{ route('index.adminBus') }}">
                                <h6 class="text-xl">Tabel Bus</h6>
                            </a>
                            <form action="{{ route('search.bus') }}" method="GET">
                                <div
                        ...
                        <a href="/admin/bus/add-bus" class="bg-slate-500 text-white p-3 rounded-lg text-xs">+ Tambah Bus</a>
                    </div>
                            ...
                            <table class="items-center w-full mb-0 align-top border-gray-200 text-slate-500">
                                <thead class="align-bottom">
                                    ...
                                    <th
                                        ...
                                        Status Bus</th>
                                    <th
                                        class="px-5 py-3 font-bold text-left uppercase align-middle bg-transparent border-b border-gray-200 shadow-none text-xxs border-b-solid tracking-none whitespace-nowrap text-slate-400 opacity-70">
                                        Kelas Bus</th>
                                    <th
                                        class="px-5 py-3 font-bold text-left uppercase align-middle bg-transparent border-b border-gray-200 shadow-none text-xxs border-b-solid tracking-none whitespace-nowrap text-slate-400 opacity-70">
                                        Jumlah Seat</th>
                                    ...
                                    @foreach ($bus as $bus)
                                        <tr>
                                            <td
                                                ...
                                                <p class="mb-0 text-xs font-semibold leading-tight ">{{ $bus->ID_bus }}</p>
                                            </td>
                                            <td
                                                class="p-2 align-middle bg-transparent border-b whitespace-nowrap shadow-transparent">
                                                <p class="mb-0 text-xs font-semibold leading-tight">{{ $bus->Bus_Model }}
                                                </p>
                                            </td>
                                            <td
                                                class="p-2 pl-3 align-middle bg-transparent border-b whitespace-nowrap shadow-transparent">
                                                <p class="mb-0 text-xs font-semibold leading-tight">{{ $bus->Mesin_Bus }}
                                                </p>
                                            </td>
                                            <td class="p-2 pl-6  align-middle bg-transparent border-b shadow-transparent ">
                                                <a
                                                    class="mb-0 text-xs font-semibold leading-tight ">{{ $bus->Tahun_Bus }}</a>
                                            </td>
                                            <td class="p-2 pl-6  align-middle bg-transparent border-b shadow-transparent ">
                                                <a
                                                    class="mb-0 text-xs font-semibold leading-tight ">{{ $bus->Jadwal_Service }}</a>
                                            </td>
                                            <td class="p-2 pl-6  align-middle bg-transparent border-b shadow-transparent ">
                                                <a
                                                    class="mb-0 text-xs font-semibold leading-tight ">{{ $bus->Status_Bus }}</a>
                                            </td>
                                            <td class="p-2 pl-6  align-middle bg-transparent border-b shadow-transparent ">
                                                <a
                                                    class="mb-0 text-xs font-semibold leading-tight ">{{ $bus->Kelas_Bus }}</a>
                                            </td>
                                            <td class="p-2 pl-6  align-middle bg-transparent border-b shadow-transparent ">
                                                <a
                                                    class="mb-0 text-xs font-semibold leading-tight ">{{ $bus->Jumlah_Seat }}</a>
                                            </td>

                                            @foreach ($sopir as $sopirBus)
                                                @if ($bus->ID_Bus == $sopirBus->ID_Bus)
                                                    <td
                                                        class="p-2 pl-6  align-middle bg-transparent border-b shadow-transparent ">
                                                ...
                                                @endif
                                            @endforeach
                                            @foreach ($kernet as $kernetBus)
                                                @if ($bus->ID_Bus == $kernetBus->ID_Bus)
                                                    <td
                                                        class="p-2 pl-6  align-middle bg-transparent border-b shadow-transparent ">
                                                        <a class="mb-0 text-xs font-semibold leading-tight ">
                                                            {{ $kernetBus->Nama }}
                                            ...
                                            <td
                                                class="p-2 pl-6 align-middle bg-transparent border-b whitespace-nowrap shadow-transparent">
                                                <a href="bus/edit-bus/{{ $bus->ID_bus }}"><svg
                                            ...
                                            <td
                                                class="p-2 pl-6 align-middle bg-transparent border-b whitespace-nowrap shadow-transparent">
                                                <form action="bus/delete-bus/{{ $bus->ID_Bus }}" method="POST">
                                                    @csrf
                                                    @method('delete')
                                                    <button type="submit">
